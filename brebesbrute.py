...
def banner():
    ...
    runntxt(WW+"     ....       MR.ONTA")
    runntxt(GL+"                   BODO AMAT NJING")
    runntxt(GG+"     ..........     ADUS NDISIT MANA")
    runntxt(Y+"    ............       DILARANG COKLI")
    runntxt(GG+"           INGAT NJING ")
    time.sleep(1.5)
    print GG+"  v=============================================v"
    print GL+"  |••••••   TOOLS ANYAR BRUTE FORCE FB.   ••••••|"
    print GG+"  v=============================================v"
    print WW+"  |            MOD BY: BREBES CENDOL            |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |        TEAM : InDoNeSiA CYBER ErRoR SyStEm  |"
    print Y+"  |             FACEBOOK: GALANK RAMBU ANARKI    |"
    print GL+"  |---------------------------------------------|"
...
print wd+"         gunakan dengan bijak SU "
...
def pil():
                ...
                if g == 'y' or g == 'Y':
                    ...
                    print RR+"Pilih sing bener cuk..."
                    pil()

def edit_wordlist():

        print GG+" "
        ed = str(raw_input("[?] Edit wordlist su.? \033[96;1m[y/n]: "))
        if ed == 'y' or ed == 'Y':
                os.system('nano '+password_list)
                pil()
        elif ed == 'n' or ed == 'N':
                print wd+"metu sing Program..."
                sys.exit()
